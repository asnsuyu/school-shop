    ...
    <div class="container">
      <div class="bread-container" v-if="goods.details">
        <el-breadcrumb separator=">">
          ...
          <!-- 
            页面刚加载的时候，goods还是空对象（未请求完成），此时获取其categories属性会失败（显示无法读取undefined）
            解决方法：
            1.对goods使用?.可选链，属性存在才继续读取
            2.对整个div使用v-if，数据请求完成后才渲染
           -->
        ...
        <div>
          <div class="goods-info">
            ...
            <div class="spec">
              ...
              <!-- 数据组件 -->
              <el-input-number v-model="count" :min="1" :max="10" @change="cartChange"/>
              <!-- 按钮组件 -->
              <div>
